...
void UAuraAbilitySystemComponent::AddCharacterAbilitiesFromSaveData(ULoadScreenSaveGame* SaveData)
{
	for (const FSavedAbility& Data : SaveData->SavedAbilities)
	{
		...
		FGameplayAbilitySpec LoadedAbilitySpec = FGameplayAbilitySpec(LoadAbilityClass, Data.AbilityLevel);
                                                                    ...
                                                                    const FGameplayTag& Slot)
{
	if (FGameplayAbilitySpec* AbilitySpec = GetSpecFromAbilityTag(AbilityTag))
	{
		...
		const bool bStatusValid = Status.MatchesTagExact(GameplayTags.Abilities_Status_Unlocked) ||
                                                              ...
                                                              FString& OutNextLevelDescription)
{
	...
	else
	{
		OutDescription = UAuraGameplayAbility::GetLockedDescription(
			AbilityInfo->FindAbilityInfoByTag(AbilityTag).LevelRequirement);
	}
